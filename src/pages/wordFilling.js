...
function WordFilling() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const filenameResponse = await axios.get("https://pdf-auto-bd-1.onrender.com/get-zip-filename");
      ...
      const response = await axios.post("https://pdf-auto-bd-1.onrender.com/generate-documents", {}, {
