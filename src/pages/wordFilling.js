...
function WordFilling() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const filenameResponse = await axios.get("https://https://pdf-auto-bd-78m3.onrender.com/get-zip-filename");
      ...
      const response = await axios.post("https://https://pdf-auto-bd-78m3.onrender.com/generate-documents", {}, {
