...
function DiseaseEngine() {
  ...
  const handleRunDiseaseProcessing = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://pdf-auto-bd.vercel.app/save-extracted-data", modifiedData);
      // console.log("Data saved:", response.data);

      // Send data for processing
      const processResponse = await axios.post("https://pdf-auto-bd.vercel.app/disease-processing/", modifiedData);
